...
export default function Dropdown() {
  ...
  return (
    <div className="Dropdown">
      <h3 className="dropdown_name" onClick={toggleShowDropdown}>
        Star Taskz
      </h3>
      {showDropdown && (
        <div className="dropdown_content" style={{ overflowY: "scroll" }}>
          <span className="Workspace">
            ...
            <ul>
              <li>
                <a href="#">
                  <GrSettingsOption className="settings-icon" />
                  Settings
                </a>
              </li>
              <li>
